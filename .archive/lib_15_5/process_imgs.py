...
def get_pairs_from_cams(image, pc) -> (list, Poles, any):
    """ function that makes masks, contours and than founds poles and pairs of poles

    :param image:   # RGB image from camera
    :param pc:      # point cloud from depth camera
    :return:
    """
    # TODO: docstring
...
def get_masks(image):
    """ function that founds masks for poles
        ...
        :param image        # cv2 image of rgb colors from cam
...
def get_contours(masks: Masks) -> Contours:    # TODO: add comments
    """ function that founds contours of r,g,b masks
        ...
        :param masks    # tuple of (r,g,b) masks
